...
realtimeChannelRef.current?.send({
  ...
  .coachboard-login-page {
    ...
    overflow: hidden;
    background:
      radial-gradient(circle at 20% 20%, rgba(239,68,68,.28), transparent 25%),
      radial-gradient(circle at 80% 80%, rgba(127,29,29,.35), transparent 28%),
      linear-gradient(135deg, #020617 0%, #05070d 55%, #000 100%);
    color: white;
  ...
  .coachboard-feature h3 {
    margin: 0 0 6px;
    font-size: 28px;
    font-weight: 950;
  }

  .coachboard-feature p {
    margin: 0;
    color: #d1d5db;
    font-size: 18px;
    line-height: 1.45;
  ...
  .coachboard-login-options span:last-child {
    color: #ef4444;
  }
  ...
  .coachboard-login-button {
    ...
    font-weight: 950;
    cursor: pointer;
    box-shadow: 0 20px 42px rgba(239,68,68,.35);
  }
